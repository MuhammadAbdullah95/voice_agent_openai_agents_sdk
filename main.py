...
from agents.voice import StreamedAudioInput, VoicePipeline, OpenAISTTModel, OpenAITTSModel

stt_model = OpenAISTTModel(model="gemini-2.5-flash", openai_client=client)
tts_model = OpenAITTSModel(model="gemini-2.5-flash-preview-tts", openai_client=client)

from agent1 import MyWorkflow
...
class RealtimeApp(App[None]):
    ...
    def __init__(self) -> None:
        ...
        self.pipeline = VoicePipeline(
            workflow=MyWorkflow(secret_word="dog", on_start=self._on_transcription),stt_model=stt_model, tts_model=tts_model
        )
